...
export default function Dashboard() {
  ...
  const { partners = [], clients = [], benefits = [], packages = [] } = useDashboardStore()
                          ...
                          partnersPaged.map(p => (
                            <tr key={p.id}>
                              ...
                              <td>
                                <Link to={`/dashboard/partners/view/${p.id}`} className="action-icon" title="View" aria-label="View"><FaEye /></Link>
                                <Link to={`/dashboard/partners/edit/${p.id}`} className="action-icon" title="Edit" aria-label="Edit"><FaEdit /></Link>
                                {p.partnerType === 'organization' && getClientIdForPartner(p.id) && (
                                  <Link to="/dashboard/benefit/create" state={{ clientId: getClientIdForPartner(p.id) }} className="action-icon" title="Create Benefit" aria-label="Create Benefit for this organization"><FaPlusCircle /></Link>
                                )}
                              </td>
                            </tr>
                          ))
