...
const initialTests = [
  { id: 't1', partnerId: 'p2', testCode: 'VD-001', testName: 'Complete Blood Count (CBC)', type: 'test', category: 'Haematology', parameters: 'Hemoglobin, WBC, RBC, Platelets, PCV, MCV, MCH, MCHC', mrp: 600, price: 450, tat: '6 hours', sampleType: 'Blood', homeCollection: true, formType: 'PATHALOGY', gender: 'both', composition: [], status: 'active' },
  { id: 't2', partnerId: 'p2', testCode: 'VD-002', testName: 'Lipid Profile', type: 'test', category: 'Biochemistry', parameters: 'Total Cholesterol, HDL, LDL, Triglycerides, VLDL', mrp: 900, price: 700, tat: '12 hours', sampleType: 'Blood', homeCollection: true, formType: 'PATHALOGY', gender: 'both', composition: [], status: 'active' },
  { id: 't3', partnerId: 'p2', testCode: 'VD-003', testName: 'Thyroid Profile (T3, T4, TSH)', type: 'test', category: 'Endocrinology', parameters: 'T3, T4, TSH', mrp: 1200, price: 950, tat: '24 hours', sampleType: 'Blood', homeCollection: true, formType: 'PATHALOGY', gender: 'both', composition: [], status: 'active' },
  { id: 't4', partnerId: 'p2', testCode: 'VD-004', testName: 'Blood Glucose Fasting', type: 'test', category: 'Biochemistry', parameters: 'Blood Glucose', mrp: 200, price: 150, tat: '4 hours', sampleType: 'Blood', homeCollection: true, formType: 'PATHALOGY', gender: 'both', composition: [], status: 'active' },
  { id: 't5', partnerId: 'p2', testCode: 'MQ-001', testName: 'Urine Routine & Microscopy', type: 'test', category: 'Microbiology', parameters: 'Color, Transparency, pH, Protein, Glucose, WBCs, RBCs, Casts', mrp: 300, price: 220, tat: '6 hours', sampleType: 'Urine', homeCollection: false, formType: 'PATHALOGY', gender: 'both', composition: [], status: 'active' },
  { id: 't6', partnerId: 'p2', testCode: 'MQ-002', testName: 'Liver Function Test (LFT)', type: 'test', category: 'Biochemistry', parameters: 'Bilirubin, ALT, AST, ALP, Albumin, Total Protein', mrp: 1100, price: 850, tat: '12 hours', sampleType: 'Blood', homeCollection: true, formType: 'PATHALOGY', gender: 'both', composition: [], status: 'active' },
  { id: 't7', partnerId: 'p2', testCode: 'MQ-003', testName: 'Kidney Function Test (KFT)', type: 'test', category: 'Biochemistry', parameters: 'Creatinine, Urea, Uric Acid, Electrolytes', mrp: 850, price: 680, tat: '12 hours', sampleType: 'Blood', homeCollection: true, formType: 'PATHALOGY', gender: 'both', composition: [], status: 'active' },
  { id: 'prof1', partnerId: 'p2', testCode: 'PROFILE-001', testName: 'Basic Health Checkup', type: 'profile', category: 'Preventive', parameters: 'Comprehensive basic health screening package', mrp: 2500, price: 2000, tat: '24 hours', sampleType: 'Blood', homeCollection: true, formType: 'PATHALOGY', gender: 'both', composition: ['VD-001', 'VD-002', 'VD-004'], status: 'active' },
]
